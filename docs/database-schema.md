...
Heartbeat cadence is single-sourced in `@tdpos/shared`: mobile registers background sync at a 15-minute minimum interval, web marks active devices stale after 45 minutes, and web marks them offline after 24 hours. Lost and inactive devices keep their explicit lifecycle status regardless of heartbeat age.
