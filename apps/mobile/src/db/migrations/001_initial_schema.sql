-- TD POS — Local SQLite Schema (001)
-- Canonical pieces model per spec §6.4
-- This schema is the LOCAL source of truth for offline-first operation.
-- Server schema lives in supabase/migrations/
...
-- ============================================================
-- SALES (immutable — no UPDATE except synced_at, no DELETE)
-- ============================================================
...
-- ============================================================
-- SALE ITEMS (always stored in pieces)
-- ============================================================
...
-- ============================================================
-- SYNC QUEUE (local only — never on Supabase)
-- Each row carries a client_operation_id for idempotent sync
-- ============================================================
...
-- Per (branch_code, cashier_code, date) — monotonically increasing
-- ============================================================
...
-- ============================================================
-- SETTINGS (module toggles, device config)
-- ============================================================
