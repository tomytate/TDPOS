...
- **Current baseline:** v0.8 Scaffold Complete — all five tier surfaces implemented, 105 tests passing, 12-stage foundation gate green.
...
├── supabase/                # PG17 migrations (12), Edge Functions (3), seed
