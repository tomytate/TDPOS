...
- **Current baseline:** v0.8 Scaffold Complete — all five tier surfaces implemented, 103 tests passing, 12-stage foundation gate green.
...
├── supabase/                # PG17 migrations (11), Edge Functions (3), seed
