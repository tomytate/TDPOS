...
export const DEVICE_HEARTBEAT_MINIMUM_INTERVAL_MINUTES = 15
export const DEVICE_HEARTBEAT_STALE_AFTER_MINUTES = 45
export const DEVICE_HEARTBEAT_OFFLINE_AFTER_HOURS = 24
